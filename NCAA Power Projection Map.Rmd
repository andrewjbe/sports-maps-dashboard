...
setwd("C:/Users/Andrew/Documents/GitHub/sports-maps-dashboard/")
...
# 
# ds <- ds %>%
#   dplyr::select(!c(color, alternate_color))
# 
...
leaflet() %>%
  ...
  addPolygons(data = counties_grouped, smoothFactor = 0.2, color = ~fill_team(team), fillOpacity = 0.8, label = ~team,
              highlightOptions = highlightOptions(color = 'white', weight = 1, 
                                                  bringToFront = FALSE)) %>%
  addCircleMarkers(data = ds, label = ~team, stroke = F, fillOpacity = 0.8, color = ~color, radius = 5, 
...
# rankplot <- function(plot_title) {
#   ggplot(tc %>%
#                   file_year %in% c(2015, 2018, 2021)),
#          aes(file_year, rank, color = ct_cat)) +
#     geom_line(size = 2) +
#     geom_label(aes(label = paste0(ct_cat, "\n(", n, ")")),
#                color = "black",
#                family = "Courier") +
#     theme_ojo() +
#     theme(legend.position = "none") +
...
#          subtitle = "Oklahoma County, 2015, 2018, and 2021 YTD",
#          x = NULL,
#          y = NULL) +
...
# }
# rankplot("CF", "Most common top offenses for felony cases")
